...
Para este desafio, a API deve ser criada utilizando-se de **Java ou Kotlin e Spring Boot**.
...
Vamos propôr a seguir alguns desafios extras caso você queira testar seus conhecimentos ao máximo\!
